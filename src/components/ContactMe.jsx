...
const ContactMe = () => {
  return (
    <div className="w-full bg-black text-white px-6 md:px-16 py-10">
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center md:justify-between min-h-screen">
